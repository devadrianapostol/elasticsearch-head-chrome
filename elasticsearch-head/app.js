...
(function( app, i18n ) {
	...
	app.App = ui.AbstractWidget.extend({
		...
		_openTasks_handler: function(ev) {
            this.navigateTo("Tasks", { cluster: this.cluster, clusterState: this._clusterState }, ev );
		},
			...
			return { tag: "DIV", cls: "uiApp", children: [
				{ tag: "DIV", id: this.id("header"), cls: "uiApp-header", children: [
					...
					{ tag: "DIV", cls: "uiApp-headerMenu", children: [
						...
						{ tag: "DIV", cls: "uiApp-headerMenuItem pull-left", text: i18n.text("Nav.Tasks"), onclick: this._openTasks_handler, children: [
								{ tag: "A", cls: "uiApp-headerNewMenuItem ", text: '' }
						] },
					]}
				]},
